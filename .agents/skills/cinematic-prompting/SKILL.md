...
- At the beginning of every new project, ask whether exact brand hex colors or a supplied brand palette should be deliberately incorporated. Record the codes, their priority, and the intended visual surfaces, or record that no color is locked.
- Treat plausibly inhabited, operational spaces as the default. Public, commercial, travel, hospitality, workplace, and social settings should include context-appropriate background people and secondary activity unless the user explicitly wants isolation, exclusivity, closure, or emptiness.
